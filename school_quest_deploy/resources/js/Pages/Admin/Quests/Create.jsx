    ...
    return (
        <AdminLayout>
            ...
            <div className="flex items-center gap-3 sm:gap-4 mb-5 sm:mb-6">
                ...
                <h1 className="text-xl sm:text-2xl font-bold text-white">Buat Additional Quest Baru</h1>
            </div>
                    ...
                    <form onSubmit={submit} className="space-y-5 sm:space-y-6">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                className="w-full bg-black/50 border border-gray-700 rounded-lg p-3 text-white focus:border-blue-500 outline-none font-game text-sm"
                                min="10"
                                max="1000"
                                required
                            />
                        ...
                        <div className="flex items-center gap-2 mt-4">
                            ...
                            />
                            <label htmlFor="is_active" className="text-xs sm:text-sm text-gray-300 cursor-pointer">Aktifkan quest langsung</label>
                        </div>

                        <div className="pt-4 border-t border-gray-800 flex flex-col-reverse sm:flex-row justify-end gap-2.5 sm:gap-3">
                            <Link href="/admin/quests" className="px-6 py-2.5 sm:py-2 rounded-lg text-gray-400 hover:bg-gray-800 transition-colors text-center text-sm font-semibold">
                                Batal
                            </Link>
                            <button 
                                type="submit"
                                disabled={processing}
                                className="bg-blue-600 hover:bg-blue-500 text-white px-6 py-2.5 sm:py-2 rounded-lg font-bold shadow-md transition-all cursor-pointer text-sm"
                            >
