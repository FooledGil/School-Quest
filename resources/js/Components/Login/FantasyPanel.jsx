...
export default function FantasyPanel({ className = '' }) {
    ...
    useEffect(() => {
        ...
        const ctx = gsap.context(() => {
            // Subtle floating motion for the castle/scene
    ...
    return (
        <div
            ref={containerRef}
            className={`relative w-full h-full min-h-[380px] lg:min-h-[500px] rounded-2xl lg:rounded-3xl overflow-hidden border-2 border-[#22304c] shadow-2xl bg-[#141b2d] flex items-center justify-center select-none ${className}`}
        >
            <div ref={castleRef} className="w-full h-full">
                ...
                >
                    ...
                    <g ref={beamRef} className="magic-beam">
                        ...
                        <circle cx="384" cy="200" r="10" fill="#38bdf8" opacity="0.35" />
                    </g>
                    ...
                    <polygon points="242,82 254,87 242,92" fill="#38bdf8" />
                    ...
                    <polygon points="174,135 184,139 174,143" fill="#f59e0b" />
                    ...
                    <polygon points="310,140 320,144 310,148" fill="#38bdf8" />
                    ...
                    {/* Glowing circular magic window on main tower */}
                    <circle cx="242" cy="180" r="10" fill="#38bdf8" opacity="0.9" />
                    <circle cx="242" cy="180" r="6" fill="#e0f2fe" />
                    <circle cx="242" cy="180" r="16" fill="#38bdf8" opacity="0.3" />
                    ...
                    {/* Torch Stand & Fire on Bridge Entrance */}
                    <g transform="translate(295, 305)">
                        ...
                        <g ref={torchRef}>
                            ...
                            <circle cx="6" cy="2" r="14" fill="#f59e0b" opacity="0.3" />
                        </g>
                    </g>
                    ...
                    {/* Stepped Rice Terraces in Foreground (Green layers) */}
                    {/* Terrace 1 (Top) */}
                    <path
                    ...
                    {/* Dark Green Pine Forest Framing (Left and Bottom) */}
                    <g fill="#142c22">
                        {/* Tree Left tall */}
