...
export default function QuestCard({ quest = {}, onComplete, isCompleted, submissionStatus, rejectionReason }) {
    ...
    return (
        <div 
            ...
            className={`glass-card p-5 relative flex flex-col justify-between transition-colors duration-200 ${
        ...
        >
            ...
            <div>
                <div className="flex justify-between items-center mb-3">
                    <span className={`px-2 py-0.5 text-[10px] uppercase font-bold tracking-wider rounded border ${diffClass}`}>
                ...
                {submissionStatus === 'rejected' && (
                    <div className="mb-3 p-2.5 bg-rose-500/10 border border-rose-500/20 rounded-lg">
                        ...
                        {rejectionReason && (
                            <p className="text-rose-300/80 text-[11px] leading-relaxed">{rejectionReason}</p>
                        )}
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-2">
                            ...
                            <button
                                ...
                                className="bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 disabled:cursor-not-allowed text-white px-3 py-1.5 rounded-lg flex items-center gap-1.5 text-xs font-bold transition-colors shadow-sm cursor-pointer"
                            >
            ...
            <div className="flex items-center justify-between pt-3 border-t border-slate-800">
                ...
                {!isCompleted && submissionStatus !== 'pending' && submissionStatus !== 'approved' && !showProofForm && (
                    <button 
                        ...
                        className="bg-blue-600 hover:bg-blue-500 text-white px-3 py-1.5 rounded-lg flex items-center gap-1.5 text-xs font-bold transition-colors shadow-sm active:scale-95 cursor-pointer"
                    >
